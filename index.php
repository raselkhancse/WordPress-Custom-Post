 ...
 * Version: 1.0.0
 * Author: Rasel Khan
 * Author URI: http://rasel.altelalbuilding.com/
 * License: GPL2
 */


require 'custom-post.php';
// require 'template-option.php';
?>
...
class Option{
    ...
    ?>
    <div class="wrap" >
        <?php screen_icon('themes'); ?> <h2 class="icon-32" style="color:#1E8CBE;"><img style="width:30px;height:30px;border-radius:23px;" src="<?php echo plugins_url('images/settings.jpg', __FILE__); ?>" alt=""> Custom Template Post Layout</h2>
                ...
                <tr valign="top">
                  <th scope="row">Custom Post Menu Name</th>
                    ...
                    <td><input type="text" name="custompost_menu_name" placeholder="Enter your menu name" value="<?php echo esc_attr( get_option('custompost_menu_name') ); ?>" />
                        <span><i>Enter your custom menu name, default is "Mypost"</i></span>
                    </td>
                </tr>
...
require 'short-code-custom-post.php';
require 'template-fun.php';
